...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <img src="./images/img1.jpg" class="d-block w-100" alt="binliotheque 1">
            <div class="carousel-caption  d-block">
                <h5>welcome to balicharmen</h5>
                <p> l'espace le plus sympat</p>
            </div>
        </div> 

        <!--image 2-->
        <div class="carousel-item " >
            <img src="./images/img2.jpg" class="d-block w-100" alt="binliotheque 2">
            <div class="carousel-caption  d-block">
                <h5>welcome to balicharmen</h5>
                <p> l'espace le plus sympat</p>
            </div>
        ...
        <!--image 3-->
        <div class="carousel-item">
            <img src="./images/img3.jpg" class="d-block w-100" alt="binliotheque 3">
            <div class="carousel-caption d-block">
                <h5>welcome to balicharmen</h5>
                <p> l'espace le plus sympat</p>
            </div>
        ...
        <!--image 4-->
        <div class="carousel-item">
            <img src="./images/img4.jpg" class="d-block w-100" alt="binliotheque 4">
            <div class="carousel-caption d-block">
                <h5>welcome to balicharmen</h5>
                <p> l'espace le plus sympat</p>
            </div>
        ...
        <!--image 5-->
        <div class="carousel-item">
            <img src="./images/img5.jpg" class="d-block w-100" alt="binliotheque 5">
            <div class="carousel-caption d-block">
                <h5>welcome to balicharmen</h5>
                 <p> l'espace le plus sympat</p>
            </div>

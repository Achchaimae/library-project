...
<!--trouver emplois ou stage-->
<div class="container2">
    <div class="row">
        <div class="col-25">
            <img src="./images/emplois.png" alt="" width="300" height="200" >
        </div>

        <div class="col-75">
            <p>Pas d'emplois ou stage pour le moment ,<br> pour plus d'information  : 
                <h5><a href="contact.php">contacter-nous</a>
                </h5><br>
            </p>
        </div>
    </div>

...
<!--end navbar-->
 ...
 <div class="container2">
  <table class="table">
    ...
    <tr>
      <td> 
        <ul>
          <li><a class="nav-link active" href="#photocopie">Photocopier / Imprimer / Scanner</a></li>
          <li><a class="nav-link active" href="#Wifi">WIFI</a></li>
          <li><a class="nav-link active" href="#Handicap">Services Handicap</a></li>
          <li><a class="nav-link active" href="#Salle">Salle</a></li>
        </ul>
      </td>
 ...
 <!--Partie Photocopie-->
 <div class="container2">
<h3><a name="photocopie">Photocopier / Imprimer / Scanner</a></h3>
<hr>
<table class="table">
    <tr>
        <td width="30%"><img src="./images/photocopie" width="100%" height="30%" ></td>
        <td colspan="2">Nous imprimons vos documents en noir et blanc ou en couleurs, directement à partir de vos supports numériques ou d'un simple e-mail contenant le document envoyé à <a href="contact.php">Contactez-nous</a>.<br>
        enfin de récuperer vos documents joignez nous à la salle d'impression ,étage 1 salle1 .<br>
        </td>
    </tr>
</table>
  <!--Fin Partie Photocopie-->
  <!--Partie Wifi-->
<h3><a name="Wifi"> Wifi</a></h3>
<hr>
<table class="table">
    <tr>
        <td width="30%"><img src="./images/wifi2" width="100%" height="30%"></td>
        <td colspan="2">Nous possedons une salle de wifi dédiée pour nos clients , le service wifi est gratuit <br>
        joignez nous à l'étage 1 salle 2 </td>
    </tr>
</table>
  <!--Fin Partie Wifi-->
  <!--Partie Services Handicap-->
<h3><a name="Handicap">  Services Handicap</a></h3>
<hr>
<table class="table">
    <tr>
        <td width="30%"><img src="./images/handicap.jpg" width="100%" height="30%"></td>
        <td colspan="2">Afin que tous le monde bénéfice de nos services ,nous fournissons a chaque personne souffre d'un handicap  un assistant qui lui aide pour travailler dans des mieux conditions  </td>
    </tr>
</table>
  <!--Fin Partie Services Handicap-->
  <!--Partie Salle-->
<h3><a name="Salle">Salle</a></h3>
<hr>
<table class="table">
	 <tr>
        <td colspan="3"><h5>Nous possédons 2 types de salles :</h5></td>
    </tr>
    <tr>
        <td width="30%"><img src="./images/reunion.jpg" width="100%" height="30%"></td>
        <td colspan="2">
        	<h6>Salle de réunion</h6>
        	<p>Cette salle est prévue pour des événements singuliers tels que des conférences d'affaires et réunions<br>
        	pour y accéder <a href="contact.php">contactez nous</a>. </p>
        </td>
    </tr>
    <tr>
        <td width="30%"><img src="./images/presentation.jpg" width="100%" height="30%"></td>
        <td colspan="2"><h6>Salle de présentation</h6>
        	<p> Cette salle est reservé pour la presentation des projets, exposés...<br>
        	pour y accéder <a href="contact.php">contactez nous</a>.
        	</p>
        </td>
    </tr>
</table>

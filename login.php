  ...
  <form action="" method="POST">
        <div class="row">
            <div class="col-25">
             ...
             <div class="col-75">
                <input type="email" id="nom" name="mail" placeholder="Votre mail..">
            </div>
        </div>
       ...
       <div class="row">
            ...
            <div class="col-75">
                <input type="password" id="prenom" name="password" placeholder="Votre mot de passe..">
            </div>
       </div>
        <div class="row">
            <input type="submit" value="login">
            <p id="texte-inscription">si vous pouvez reserver des livre en ligne s'inscrez-vous:</p>
